...
public class CatalogAdminView extends BorderPane {
        ...
        var t = new Task<Void>() {
            @Override protected Void call() throws Exception {
                try {
                    ...
                    Platform.runLater(() -> {
                        String err = Ui.essentialError(ex);
                        status.setText(err);
        ...
        var t = new Task<Product>() {
            ...
            @Override protected void succeeded() {
                Platform.runLater(() -> {
                    ...
                    Ui.toastSuccess(CatalogAdminView.this, I18n.t("catalogAdmin.created"));
    ...
    private void creerCategorie(String nom, String description, String imageUrl) {
        ...
        var t = new Task<Category>() {
            ...
            @Override protected void succeeded() {
                Platform.runLater(() -> {
                    status.setText(Ui.safe(I18n.t("catalogAdmin.categoryCreated")));
                    Ui.toastSuccess(CatalogAdminView.this, I18n.t("catalogAdmin.categoryCreated"));
                    load();
                });
            }
            @Override protected void failed() {
